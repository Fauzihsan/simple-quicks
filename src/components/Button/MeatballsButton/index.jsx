...
function MeatballsButton() {
  ...
  return (
    <div>
      <button className="flex align-top" onClick={handleButtonClick}>
        <svg width="21" height="6" className="mt-2" viewBox="0 0 21 6" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            fillRule="evenodd"
            clipRule="evenodd"
      ...
      {isMenuShown && (
        <div className="absolute bg-white w-24">
          <button className="text-primary-blue p-2" onClick={() => {}}>
            Edit
          </button>
          <hr />
          <button className="text-red-600 p-2" onClick={() => {}}>
            Delete
          </button>
        </div>
      )}
