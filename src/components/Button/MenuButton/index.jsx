...
function MenuButton(props) {
  return (
    <button className={`bg-primary-blue mt-4 rounded-full w-14 h-14 ${props.showMenu ? "animate-pulse" : ""} `} title="Click to expand menu" onClick={props.handleShow}>
      <svg width="18" height="32" viewBox="0 0 18 32" fill="none" xmlns="http://www.w3.org/2000/svg" className="m-auto">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
