...
function SearchChat() {
  return (
    <div className="py-3 px-7 bg-white rounded-md fixed w-3/4 z-50">
      <form className="w-full flex gap-2 p-3 border-solid border-2 border-gray-700 rounded-xl">
        <input type="text" placeholder="Search" className="w-full bg-transparent border-none outline-none pl-10 text-[#4a4a4a]" />
        <button type="submit">
